  ...
  return (
    <div className="player-card">
      <div className="player-info">
        <img className="player-team-img-card" src={`https://cdn.nba.com/logos/nba/${teamImages[props.player.team]}/primary/D/logo.svg`} alt={props.player.team} />
        <h3 className="player-name-card">{formatName(props.player.name)}</h3>
        <img className='player-img-card' src={props.player.img} alt={props.player.name} />
